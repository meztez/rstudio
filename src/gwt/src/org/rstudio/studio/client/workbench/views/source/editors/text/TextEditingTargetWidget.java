      ...
      implements Display, RequiresVisibilityChanged
{
   ...
   private Toolbar createToolbar(TextFileType fileType)
   {
      ...
      knitDocumentButton_ = commands_.knitDocument().createToolbarButton(false, column_);
      ...
      insertChunkButton_ = commands_.insertChunk().createToolbarButton(false, column_);
      toolbar.addRightWidget(insertChunkButton_);

      toolbar.addRightWidget(runButton_ = commands_.executeCode().createToolbarButton(false, column_));
      toolbar.addRightSeparator();
      toolbar.addRightWidget(runLastButton_ = commands_.executeLastCode().createToolbarButton(false, column_));
      toolbar.addRightWidget(goToPrevButton_ = commands_.goToPrevSection().createToolbarButton(false, column_));
      toolbar.addRightWidget(goToNextButton_ = commands_.goToNextSection().createToolbarButton(false, column_));
      toolbar.addRightSeparator();
      ...
      previewJsButton_ = commands_.previewJS().createToolbarButton(false, column_);
      toolbar.addRightWidget(previewJsButton_);

      previewSqlButton_ = commands_.previewSql().createToolbarButton(false, column_);
